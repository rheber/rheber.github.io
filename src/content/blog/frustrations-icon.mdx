...
So I gave up on attempting to use an AI favicon generator. Funnily enough, one of my initial search results was [favicon.io](https://favicon.io/) which didn't
